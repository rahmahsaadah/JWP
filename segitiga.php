        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid">
                    <h1 class="mt-4">Hitung Luas Segitiga</h1>
                        <div class="card mb-4">
                        ...
                        <form method="post" action="">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <h5><label class="small mb-1" for="">Alas</label></h5>
                                    <input class="form-control py-4" name="alas" id="" type="number" placeholder="Masukkan Alas Segitiga" required/>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <h5><label class="small mb-1" for="">Tinggi</label></h5>
                                    <input class="form-control py-4" name="tinggi" id="" type="number" placeholder="Masukkan Tinggi Segitiga" required/>
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="button" value="Refresh" class="btn btn-info" onclick="window.location.href='segitiga.php'"/>
                            </div>
                            </div>
                        </form>
                        <?php 
                                        ...
                                        function luas_segi3($alas, $tinggi) { //nama function serat menangkap nilai pada kedua variabel yaitu pada nilai alas dan tinggi
                                        ...
                                        $file = fopen("luas_segitiga.txt","w");
                                            ...
                                            Rumus Luas Segitiga     : 0.5 x Alas Segitiga x Tinggi Segitiga
                                                                    0.5 x '.$alas.' x '. $tinggi. '
                                            Luas Segitiga           : '. luas_segi3($alas, $tinggi));
                                            fclose($file);

                                        $querypilihsegitiga = mysqli_query($koneksi, "SELECT * FROM bangun_datar WHERE bangun_datar='segitiga'") or die(mysqli_connect_error()); //query menampilkan bangun_datar: segitiga
                                        ...
                                        mysqli_query($koneksi, "UPDATE bangun_datar SET jumlah='$qty' WHERE bangun_datar='segitiga'") or die(mysqli_connect_error()); //query upate qty
                            ...
                            <div class="card-header">Hasil Perhitungan</div>
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2" name="luas"><?php echo luas_segi3($alas, $tinggi)?></h3> <!-- Hasil Perhitungan Luas Segitiga-->
                                        </div>
                                        <hr>
                                    </div>
                                <?php } ?>
